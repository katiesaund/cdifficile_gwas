...
indel_annotations <- cbind(indel_annotations, rep(NA, nrow(indel_annotations)), rep(NA, nrow(indel_annotations)))
colnames(indel_annotations) <- c(indel_orig_colnames, snp_only_colnames)

snp_annotations <- cbind(snp_annotations, rep(NA, nrow(snp_annotations)), rep(NA, nrow(snp_annotations)))
