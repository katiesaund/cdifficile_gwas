    ...
    for (k in 1:num_lineage) {
      for (l in 1:num_genotype) {
        for (m in 1:num_phenotype) {
            ...
            model_results_name <- paste0("../../../data/15_pyseer/paloc_model_results/",  model_name, ".txt")
...
write_tsv(model_results, path = "../../../data/15_pyseer/paloc_model_results/EN_model_summary.tsv", col_names = TRUE)
